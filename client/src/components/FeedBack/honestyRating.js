...
const HonestyRating = ({profileOwenrId}) => {
    ...
    useEffect(() => {
        const countt = async () => {
            totalCount= await countRating("honesty",profileOwenrId);
            totalPeopleCount = await countPeopleRating("honesty",profileOwenrId);
