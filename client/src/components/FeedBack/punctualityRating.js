...
const PonctualityRating = ({profileOwenrId}) => {
    ...
    useEffect(() => {
        const countt = async () => {
            totalCount= await countRating("punctuality",profileOwenrId);
            totalPeopleCount = await countPeopleRating("punctuality",profileOwenrId);
...
export default PonctualityRating;
