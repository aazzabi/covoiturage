...
const CompanionShipRating = ({profileOwenrId}) => {
    ...
    useEffect(() => {
        const countt = async () => {
            totalCount= await countRating("companionship",profileOwenrId);
            totalPeopleCount = await countPeopleRating("companionship",profileOwenrId);
...
export default CompanionShipRating;
