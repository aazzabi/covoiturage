...
const SafeDrivingRating = ({profileOwenrId}) => {
    ...
    useEffect(() => {
        const countt = async () => {
            totalCount= await countRating("Safe_Driving",profileOwenrId);
            totalPeopleCount = await countPeopleRating("Safe_Driving",profileOwenrId);
...
export default SafeDrivingRating;
