...
const ConfortRating = ({profileOwenrId}) => {
    ...
    useEffect(() => {
        const countt = async () => {
            totalCount= await countRating("confort",profileOwenrId);
            totalPeopleCount = await countPeopleRating("confort",profileOwenrId);
