                ...
                <div className="col-lg-4">
                    <div className="card" key={post._id}>
                        ...
                        <div className="card-body">
                            <div className="h2 mb-0 card-title"><a href={`/front/BlogDetails/${post._id}`}> {post.title}
                            </a></div>
                            <small className="text-muted">by Admin Snow on {new Date(post.time).toLocaleString()}</small>
                            <p
                            ...
                            <a href={`/front/BlogDetails/${post._id}`}
