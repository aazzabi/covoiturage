                                ...
                                <tr>
                                    ...
                                    <td>
                                        {
                                            ...
                                            : claim.priority == 'NORMAL' ? <Badge color="info" pill>In Normal</Badge>
                                            : claim.status == 'IMPORTANT' ? <Badge color="warning" pill >Important</Badge>
                                    ...
                                    <td>
                                        {
                                            ...
                                            : claim.status == 'IN_PROGRESS' ? <Badge color="info">In progress</Badge>
                                    ...
                                    <td>
                                        ...
                                        <Button variant="danger" className="btn btn-danger"
                                                onClick={e => this.deleteHandler(e, claim._id)}><i className="fa fa-trash"></i></Button>
                                    </td>
                                </tr>
                            </Fragment>
                        ))}
...
export default withRouter(connect(mapStateToProps, {deleteClaim, resolveClaim,  getAll , getCurrentUser})(AllClaims));
